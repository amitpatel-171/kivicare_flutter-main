      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              86.height,
              Image.asset('images/appIcon.png', height: 108, width: 108)
                  .center(),
              16.height,
              RichTextWidget(
                list: [
              ...
              Align(
                ...
                child: Text('Steps to generate the QR code',
              ...
              ULNew(
                ...
                children: [
                  ...
                  Text('Enter your email address as well as the temporary link',
                      style: primaryTextStyle()),
                  Text(
                      'You will see a QR for App option on the right hand corner, click on that and scan it from the app',
                      style: primaryTextStyle()),
                ],
              ),
              64.height,
              Text('Enjoy! the flawless KiviCare system with ease',
