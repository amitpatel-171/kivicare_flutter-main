...
class _PatientDashBoardFragmentState extends State<PatientDashBoardFragment> {
  ...
  Widget buildUpcomingAppointmentWidget(
      {required List<UpcomingAppointment> upcomingAppointment}) {
    return Column(
        ...
        Wrap(
          ...
          children: upcomingAppointment.take(2).map((UpcomingAppointment data) {
            return CommonAppointmentWidget(
                upcomingData: data, index: upcomingAppointment.indexOf(data));
          }).toList(),
        ).visible(
          upcomingAppointment.isNotEmpty,
          defaultWidget:
              NoDataFoundWidget(text: locale.lblNoUpcomingAppointments)
                  .center(),
        ),
      ],
    );
    ...
    return Column(
      children: [
        ...
        Wrap(
          ...
          spacing: 16,
          children: doctorList
              .map((e) => DoctorDashboardWidget(data: e))
              .take(2)
              .toList(),
        ),
      ],
      ...
      children: [
        ...
        Wrap(
          ...
          children: List.generate(
            ...
            (index) =>
                NewsDashboardWidget(newsData: newsData[index], index: index),
          ),
        )
      ],
    );
            ...
            child: Wrap(
              ...
              children: [
                buildUpcomingAppointmentWidget(
                    upcomingAppointment:
                        snap.data!.upcoming_appointment.validate()),
                buildDoctorServiceWidget(
                    service: snap.data!.serviceList.validate()),
