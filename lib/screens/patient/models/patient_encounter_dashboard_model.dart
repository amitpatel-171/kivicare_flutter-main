...
class PatientEncounterDashboardModel {
    ...
    return PatientEncounterDashboardModel(
      ...
      custom_fields: json['custom_fields'] != null
          ? (json['custom_fields'] as List)
              .map((i) => CustomField.fromJson(i))
              .toList()
          : null,
      description: json['description'],
      doctor_id: json['doctor_id'],
      enocunter_modules: json['enocunter_modules'] != null
          ? (json['enocunter_modules'] as List)
              .map((i) => EnocunterModule.fromJson(i))
              .toList()
          : null,
      doctor_name: json['doctor_name'],
      module_config: json['module_config'] != null
          ? (json['module_config'] as List)
              .map((i) => ModuleConfig.fromJson(i))
              .toList()
          : null,
      prescription_module: json['prescription_module'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.custom_fields != null) {
      data['custom_fields'] =
          this.custom_fields!.map((v) => v.toJson()).toList();
    }
    if (this.note != null) {
    ...
    if (this.enocunter_modules != null) {
      data['enocunter_modules'] =
          this.enocunter_modules!.map((v) => v.toJson()).toList();
    }
    if (this.module_config != null) {
      data['module_config'] =
          this.module_config!.map((v) => v.toJson()).toList();
    }
    if (this.prescription_module != null) {
      data['prescription_module'] =
          this.prescription_module!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
