...
class AddAppointmentScreenStep2 extends StatefulWidget {
  @override
  _AddAppointmentScreenStep2State createState() =>
      _AddAppointmentScreenStep2State();
}
...
class _AddAppointmentScreenStep2State extends State<AddAppointmentScreenStep2> {
  ...
  init() async {
    future = getDoctorListNew(
        page: page,
        doctorList: doctorList,
        getTotalPatient: (p0) => totalDoctor = p0,
    ...
    return Padding(
      ...
      child: Stack(
        children: [
          Row(
            children: [
              Text(locale.lblChooseYourDoctor,
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      ...
                      log(appointmentAppStore.mDoctorSelected!.iD);
                      // print("object");
                    },
