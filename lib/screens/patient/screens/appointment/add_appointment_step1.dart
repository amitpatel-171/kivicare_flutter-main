...
class AddAppointmentScreenStep1 extends StatefulWidget {
  @override
  _AddAppointmentScreenStep1State createState() =>
      _AddAppointmentScreenStep1State();
}
...
class _AddAppointmentScreenStep1State extends State<AddAppointmentScreenStep1> {
  ...
  init() async {
    future = getClinicListNew(
        page: page,
        appointmentList: clinicList,
        getTotalPatient: (p0) => totalClinic = p0,
    ...
    return Padding(
      ...
      child: Stack(
        children: [
          Row(
            children: [
              Text(locale.lblChooseYourClinic,
                  ...
                  return GestureDetector(
                    ...
                    child: Observer(
                      builder: (context) {
                        return ClinicWidget(
                            data: data,
                            isSelected: appointmentAppStore.mClinicSelected !=
                                    null
                                ? appointmentAppStore.mClinicSelected!.clinic_id
                                        .validate() ==
                                    data.clinic_id.validate()
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(locale.lblAddNewAppointment,
        ...
        onPressed: () {
          if (appointmentAppStore.mClinicSelected == null)
            ...
            if (appStore.isBookedFromDashboard) {
              AddAppointmentScreenStep3().launch(context,
                  pageRouteAnimation: PageRouteAnimation.Slide);
            } else {
              AddAppointmentScreenStep2().launch(context,
                  pageRouteAnimation: PageRouteAnimation.Slide);
            }
          }
        },
