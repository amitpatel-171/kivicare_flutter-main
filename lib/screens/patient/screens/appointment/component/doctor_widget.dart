...
class DoctorWidget extends StatelessWidget {
  ...
  const DoctorWidget({Key? key, required this.data, required this.isSelected})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          CachedImageWidget(
              url: data.profile_image.validate(),
              height: 100,
          ...
          Column(
            ...
            children: [
              8.height,
              Text("Dr. ${data.display_name.validate()}",
                  style: boldTextStyle(size: 18)),
              6.height,
              Text(
                data.specialties.validate().isNotEmpty
                    ? data.specialties.validate()
                    : 'NA',
