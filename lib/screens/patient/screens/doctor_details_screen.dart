      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              16.height,
              Text(locale.lblDoctorDetails, style: boldTextStyle(size: 18))
                  .expand(),
              Divider(color: appSecondaryColor.withOpacity(0.4))
                  .visible(widget.data!.available.validate().isNotEmpty),
              RoleWidget(
                ...
                child: IconButton(
                  ...
                  onPressed: () async {
                    finish(context);
                    await RAddNewDoctor(doctorList: widget.data, isUpdate: true)
                        .launch(context)
                        .then((value) {
                      if (value ?? false) {
                        setState(() {});
          ...
          Wrap(
            ...
            children: [
              ...
              if (widget.data!.no_of_experience
                  .toString()
                  .validate()
                  .isNotEmpty)
                DoctorDetailWidget(
                  ...
                  subTitle:
                      "${widget.data!.no_of_experience.toString().validate()} " +
