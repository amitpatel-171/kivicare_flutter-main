...
class _EditPatientProfileScreenState extends State<EditPatientProfileScreen> {
  ...
  void addEditedData() async {
    ...
    await updatePatientProfile(qualificationRequest,
  ...
  void getReceiptionistDetails(GetDoctorDetailModel getDoctorDetail) {
    ...
    if (getDoctorDetail.dob.validate().isNotEmpty) {
      dOBCont.text =
          getDoctorDetail.dob!.getFormattedDate(BIRTH_DATE_FORMAT).validate();
                ...
                children: [
                  ...
                  Text(locale.lblDone, style: boldTextStyle()).onTap(() {
                    if (DateTime.now().year - picked.year < 18) {
                      ...
                      finish(context);
                      dOBCont.text =
                          picked.getFormattedDate(BIRTH_DATE_FORMAT).toString();
                    }
                  })
                ],
                          ...
                          children: [
                            ...
                            Text(genderList[index].name!,
                                    style: primaryTextStyle(
                                        size: 12, color: secondaryTxtColor))
                                .flexible()
                          ],
                        ).center(),
                      ).onTap(() {
