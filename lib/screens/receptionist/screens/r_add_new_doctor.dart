...
class _RAddNewDoctorState extends State<RAddNewDoctor>
      ...
      child: Scaffold(
        ...
        body: widget.isUpdate
            ? FutureBuilder<GetDoctorDetailModel>(
                future: _memorizer
                    .runOnce(() => getUserProfile(widget.doctorList!.iD)),
                builder: (_, snap) {
                  if (snap.hasData) {
                    return Column(
                      children: [
                        ...
                        TabBar(
                          ...
                          labelColor: appStore.isDarkModeOn
                              ? Colors.white
                              : primaryColor,
                          isScrollable: true,
                          ...
                          tabs: [
                            Tab(
                                icon: Text(locale.lblBasicInfo,
                                    textAlign: TextAlign.center)),
                            Tab(
                                icon: Text(locale.lblBasicSettings,
                                    textAlign: TextAlign.center)),
                            Tab(
                                icon: Text(locale.lblQualification,
                                    textAlign: TextAlign.center)),
                          ],
                        ),
                        TabBarView(
