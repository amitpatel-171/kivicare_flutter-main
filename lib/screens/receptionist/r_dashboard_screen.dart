        ...
        return Scaffold(
                  ...
                  actions: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        padding: appStore.profileImage.validate().isNotEmpty
                            ? EdgeInsets.zero
                            : EdgeInsets.all(12),
                        ...
                        child: appStore.profileImage.validate().isNotEmpty
                            ...
                            : NameInitialsWidget(
                                firstName:
                                    appStore.firstName.validate(value: 'K'),
                                lastName:
                                    appStore.lastName.validate(value: 'V'),
                                color: Colors.white,
                              ),
                      ),
                    )
          ...
          bottomNavigationBar: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(
                icon: ic_doctorIcon.iconImage(
                    size: iconSize, color: disableIconColor),
                activeIcon: Image.asset(ic_fill_doctor,
                    height: iconSize, width: iconSize),
              ...
              BottomNavigationBarItem(
                icon: ic_more_item.iconImage(
                    size: iconSize, color: disableIconColor),
                activeIcon: Image.asset(ic_more_item_fill,
