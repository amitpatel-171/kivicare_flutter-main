...
class RPatientListSlidableComponent extends StatefulWidget {
  ...
  @override
  _RPatientListSlidableComponentState createState() =>
      _RPatientListSlidableComponentState();
}

class _RPatientListSlidableComponentState
    extends State<RPatientListSlidableComponent> {
  @override
  void initState() {
    super.initState();
    init();
    ...
    return Slidable(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            CachedImageWidget(
                url: widget.patientData!.profileImage, height: 80),
            8.width,
            Column(
              ...
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(widget.patientData!.display_name.validate(),
                    ...
                    FaIcon(FontAwesomeIcons.gaugeHigh,
                      ...
                      () {
                        EncounterScreen(
                                ...
                                image: widget.patientData!.profileImage)
                            .launch(context);
                      },
                    )
                  ],
                ...
                Row(
                  children: [
                    ...
                    10.width,
                    Text(widget.patientData!.mobile_number.validate(),
                        style: primaryTextStyle()),
                  ],
                ).onTap(() {
                  commonLaunchUrl(
                      "tel:// ${widget.patientData!.mobile_number.validate()}");
                }),
                14.height,
                Row(
                  children: [
        ...
        children: [
          SlidableAction(
            onPressed: (BuildContext context) async {
              bool? res = await AddPatientScreen(userId: widget.patientData!.iD)
                  .launch(context);
          ...
          SlidableAction(
            ...
            onPressed: (BuildContext context) async {
              showConfirmDialogCustom(
                ...
                title: locale.lblDeleteRecordConfirmation +
                    " ${widget.patientData!.display_name}?",
                onAccept: (p0) {
