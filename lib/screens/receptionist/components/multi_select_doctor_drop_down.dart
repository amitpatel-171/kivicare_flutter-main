...
class _MultiSelectDoctorDropDownState extends State<MultiSelectDoctorDropDown> {
  ...
  void getData() async {
    ...
    await getDoctorList(
            clinicId: isReceptionist() ? getIntAsync(USER_CLINIC) : "" as int?)
        .then((value) {
  ...
  onSearchTextChanged(String text) async {
    ...
    searchDoctorList.forEach((element) {
      if (element.display_name!.toLowerCase().contains(text))
          ...
          children: [
            Column(
              children: [
                ...
                Row(
                  children: [
                    Text(locale.lblSelectDoctor, style: boldTextStyle(size: 18))
                        .expand(),
                    IconButton(
              ...
              itemBuilder: (context, index) {
                ...
                return Theme(
                  ...
                  child: CheckboxListTile(
                    value: data.isCheck,
                    title: Text(data.display_name.validate(),
                        maxLines: 2,
