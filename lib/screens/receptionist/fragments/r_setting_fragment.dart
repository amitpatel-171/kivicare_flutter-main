...
class _RSettingFragmentState extends State<RSettingFragment>
  ...
  Widget buildREditProfileWidget() {
    return Column(
      ...
      children: [
          ...
          children: [
            ...
            Positioned(
              ...
              child: GestureDetector(
                onTap: () async {
                  await EditPatientProfileScreen()
                      .launch(context)
                      .then((value) {
                    if (value ?? false) {
                      setState(() {});
        ...
        28.height,
        if (isReceptionist() &&
            appStore.userEnableGoogleCal == ON &&
            isProEnabled())
                ...
                await authService.signInWithGoogle().then((user) async {
                  if (user != null) {
                    ...
                    await connectGoogleCalendar(request: request)
                      ...
                      appStore.setGoogleUsername(user.displayName.validate(),
                          initiliaze: true);
