...
class _ServiceListScreenState extends State<ServiceListScreen> {
  ...
  init() async {
    ...
    future = getServiceResponseNew(
        id: doctorId != null ? getIntAsync(USER_ID) : doctorId,
        perPages: 15,
        page: page,
            ...
            AnimatedWrap(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: boldTextStyle(),
                              ...
                              listAppStore.doctorList.isNotEmpty),
                        ],
                      )
                          .paddingLeft(20)
                          .paddingTop(8)
                  ...
                  () async {
                    await AddServiceScreen(serviceData: data).launch(context,
