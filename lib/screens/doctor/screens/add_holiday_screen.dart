...
class _AddHolidayScreenState extends State<AddHolidayScreen> {
  ...
  init() async {
    ...
    if (isUpdate) {
      ...
      dateCont.text =
          "${widget.holidayData!.start_date!.getFormattedDate(APPOINTMENT_DATE_FORMAT)} - ${widget.holidayData!.end_date!.getFormattedDate(APPOINTMENT_DATE_FORMAT)}";
      totalLeaveInDays = DateTime.parse(widget.holidayData!.end_date!)
          .difference(DateTime.parse(widget.holidayData!.start_date!))
          .inDays;
      setState(() {});
    }
  }
  ...
  void showDatePicker() async {
        ...
        return Theme(
          data: appStore.isDarkModeOn
              ...
              : ThemeData.light().copyWith(
                  ...
                  colorScheme:
                      ColorScheme.light(primary: const Color(0xFF4974dc)),
                ),
          child: child!,
        );
      },
    ...
    if (picked != null) {
      dateCont.text =
          "${picked!.start.getFormattedDate(APPOINTMENT_DATE_FORMAT)} - ${picked!.end.getFormattedDate(APPOINTMENT_DATE_FORMAT)}";
          ...
          children: [
              ...
              child: DropdownButtonFormField<String>(
                ...
                items: List.generate(
                  ...
                  (index) => DropdownMenuItem<String>(
                      child: Text(roles[index].capitalizeFirstLetter(),
            ...
            if (totalLeaveInDays != null)
              Align(
                ...
                child: Text(
                    locale.lblLeaveFor + ' $totalLeaveInDays ' + locale.lblDays,
