...
class _BillDetailsScreenState extends State<BillDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: appBarWidget(locale.lblInvoiceDetail,
  ...
  Widget body() {
    return FutureBuilder<PatientBillModule>(
      future: _memorizer
          .runOnce(() => getBillDetails(encounterId: widget.encounterId)),
      builder: (_, snap) {
        if (snap.hasData) {
          return Stack(
            fit: StackFit.expand,
                    ...
                    Row(
                      children: [
                        ...
                        Text(locale.lblDiscount,
                                ...
                                textAlign: TextAlign.end)
                            .expand(),
                        Text('${snap.data!.clinic!.extra!.currency_prefix}${snap.data!.discount.validate()}',
                                style: boldTextStyle(size: 12),
                                textAlign: TextAlign.end)
                            .expand(flex: 1),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Text(locale.lblAmountDue,
                                ...
                                textAlign: TextAlign.end)
                            .expand(),
                        Text('${snap.data!.clinic!.extra!.currency_prefix}${snap.data!.actual_amount.validate()}',
                                style: boldTextStyle(size: 12),
                                textAlign: TextAlign.end)
                            .expand(flex: 1),
                      ],
        ...
        Row(
          children: [
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('${patientBillData.clinic!.clinic_name.validate()}',
                    style: boldTextStyle()),
                4.height,
                RichTextWidget(
                  list: [
                ...
                RichTextWidget(
                  list: [
                    ...
                    TextSpan(
                      text:
                          '${patientBillData.created_at.validate().getFormattedDate('dd MMM yyyy')} ',
                      style: primaryTextStyle(size: 12),
                    ),
                  ],
                ),
            ...
            Column(
              ...
              children: [
                ...
                Text('${patientBillData.clinic!.country.validate()}',
                    style: primaryTextStyle(size: 14)),
                2.height,
                Text('${patientBillData.clinic!.clinic_email.validate()} ',
                    style: primaryTextStyle(size: 14)),
                2.height,
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      decoration: BoxDecoration(
                        ...
                        color: patientBillData.payment_status == 'paid'
      ...
      children: [
        RichTextWidget(
          list: [
            TextSpan(
                ...
                style: boldTextStyle(size: 12)),
            TextSpan(
                text: '${patientBillData.patient!.display_name.validate()}',
                style: primaryTextStyle(size: 12)),
          ],
        ),
        6.height,
        ...
        RichTextWidget(
          list: [
            ...
            TextSpan(
                text:
                    '${patientBillData.patient?.dob?.getFormattedDate('dd MMM yyyy')}',
                style: primaryTextStyle(size: 12)),
          ],
        ),
      ],
                ...
                child: Row(
                  children: [
                    ...
                    Text('${data.label.validate()}',
                            ...
                            textAlign: TextAlign.start)
                        .expand(flex: 2),
                    Text('${patientBillData.clinic!.extra!.currency_prefix}${data.price.validate()}',
                            style: primaryTextStyle(size: 12),
                            textAlign: TextAlign.center)
                        .expand(),
                    Text('${data.qty.validate()}',
                            ...
                            textAlign: TextAlign.end)
                        .expand(),
                    Text('${patientBillData.clinic!.extra!.currency_prefix}$total',
                            style: primaryTextStyle(size: 12),
                            textAlign: TextAlign.end)
                        .expand(flex: 1),
                  ],
