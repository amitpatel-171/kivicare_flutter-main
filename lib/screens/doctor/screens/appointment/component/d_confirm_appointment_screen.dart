...
class DConfirmAppointmentScreen extends StatefulWidget {
  ...
  @override
  _DConfirmAppointmentScreenState createState() =>
      _DConfirmAppointmentScreenState();
}
...
class _DConfirmAppointmentScreenState extends State<DConfirmAppointmentScreen> {
  ...
  void saveAppointment() {
    ...
    appointmentAppStore.setSelectedDoctor(listAppStore.doctorList
        .firstWhereOrNull((element) => element!.iD == getIntAsync(USER_ID)));
          ...
          Row(
            ...
            children: [
              ...
              VerticalDivider(color: viewLineColor, thickness: 1)
                  .withHeight(20),
              16.width,
              Text("${appointmentAppStore.mPatientSelected}",
                      style: boldTextStyle(size: 20))
                  .expand(),
            ],
          ),
