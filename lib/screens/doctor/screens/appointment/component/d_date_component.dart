  ...
  void initState() {
    ...
    if (widget.initialDate != null) {
      appointmentDateCont.text =
          widget.initialDate!.getFormattedDate(CONVERT_DATE);
      ...
      appointmentDateCont.text = DateTime.now()
          .add(appStore.restrictAppointmentPre.days)
          .getFormattedDate(CONVERT_DATE);
      appointmentAppStore.setSelectedAppointmentDate(
          DateTime.now().add(appStore.restrictAppointmentPre.days));
    }
    setState(() {});
    if (widget.initialDate != null) {
        ...
        AppTextField(
          ...
          onTap: () async {
            selectedDate = await showDatePicker(
              ...
              lastDate: DateTime(DateTime.now().year, DateTime.now().month + 8,
                  DateTime.now().year + 5),
              ...
              //     DateTime.now().add(appStore.restrictAppointmentPre.days),
              // lastDate:
              //     DateTime.now().add(appStore.restrictAppointmentPost.days),
            ...
            appointmentDateCont.text =
                DateFormat(CONVERT_DATE).format((selectedDate) as DateTime);
            appointmentAppStore
                .setSelectedAppointmentDate((selectedDate) as DateTime);
