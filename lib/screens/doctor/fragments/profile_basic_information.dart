...
class ProfileBasicInformation extends StatefulWidget {
  ...
  @override
  _ProfileBasicInformationState createState() =>
      _ProfileBasicInformationState();
}
...
class _ProfileBasicInformationState extends State<ProfileBasicInformation> {
  ...
  init() async {
    ...
    genderList.add(GenderModel(
        name: locale.lblMale, icon: FontAwesomeIcons.male, value: "male"));
    genderList.add(GenderModel(
        name: locale.lblFemale,
        icon: FontAwesomeIcons.female,
        value: "female"));
    genderList.add(GenderModel(
        name: locale.lblOther, icon: FontAwesomeIcons.female, value: "other"));
  ...
  Widget telemed() {
    return Column(
      ...
      children: [
        Text(locale.lblZoomConfiguration,
        ...
        SwitchListTile(
          title: Text(
            ...
            style: primaryTextStyle(
                color:
                    mIsTelemedOn ? successTextColor : textPrimaryColorGlobal),
          ),
          value: mIsTelemedOn,
          ...
          children: [
            ...
            AppTextField(
              ...
              decoration: inputDecoration(
                  context: context, labelText: locale.lblVideoPrice),
              validator: (v) {
            ...
            AppTextField(
              ...
              textFieldType: TextFieldType.OTHER,
              decoration: inputDecoration(
                  context: context, labelText: locale.lblAPIKey),
              validator: (v) {
                if (v!.trim().isEmpty) return locale.lblAPIKeyCannotBeEmpty;
                return null;
              },
            ...
            AppTextField(
              ...
              textFieldType: TextFieldType.OTHER,
              decoration: inputDecoration(
                  context: context, labelText: locale.lblAPISecret),
              validator: (v) {
  ...
  Widget zoomConfigurationGuide() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(locale.lblZoomConfigurationGuide,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  RichTextWidget(
                    ...
                    list: [
                      TextSpan(
                          text: locale.lblClickOnDevelopButton,
                          style: primaryTextStyle()),
                      TextSpan(
              ...
              Row(
                ...
                children: [
                  ...
                  6.width,
                  Text(locale.lblChooseAppTypeToJWT, style: primaryTextStyle())
                      .expand(),
                ],
              ).paddingAll(8),
              Divider(),
              Row(
                ...
                children: [
                  ...
                  6.width,
                  Text(locale.lblMandatoryMessage, style: primaryTextStyle())
                      .expand(),
                ],
              ).paddingAll(8),
              Divider(),
              Row(
                ...
                children: [
                  ...
                  6.width,
                  Text(locale.lblCopyAndPasteAPIKey, style: primaryTextStyle())
                      .expand(),
                ],
              ).paddingAll(8),
            ],
  ...
  void getDoctorDetails() {
    ...
    dOBCont.text =
        getDoctorDetail!.dob.validate().getFormattedDate(BIRTH_DATE_FORMAT);
    // picked = DateTime.parse(getDoctorDetail?.dob as String);
  ...
  Future getImage() async {
    image = (await ImagePicker().pickImage(
        source: ImageSource.gallery, imageQuality: 100)) as PickedFile?;
  ...
  void onSpecializationTap() async {
    ...
    bool? res = await MultiSelectSpecialization(selectedServicesId: ids)
        .launch(context);
    if (res ?? false) {
      multiSelectStore.selectedStaticData.forEach((element) {
        temp.add(Specialty(id: element!.id, label: element.label));
      ...
      child: Form(
        ...
        child: AnimatedScrollView(
          ...
          children: [
            ...
            16.height,
            (getStringAsync(USER_EMAIL) == receptionistEmail ||
                    getStringAsync(USER_EMAIL) == doctorEmail ||
                    getStringAsync(USER_EMAIL) == patientEmail)
                ? AppTextField(
            ...
            AppTextField(
              ...
              decoration: inputDecoration(
                ...
                labelText: locale.lblContactNumber,
                  ...
                  suffixIcon:
                      ic_phone.iconImage(size: 10, color: grey).paddingAll(14)),
            ),
            16.height,
            AppTextField(
              controller: dOBCont,
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: List.generate(
                            ...
                            (index) {
                              StaticData data =
                                  multiSelectStore.selectedStaticData[index]!;
                              return Chip(
