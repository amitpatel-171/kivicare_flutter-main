          ...
          children: [
            ...
            Column(
              ...
              children: [
                  ...
                  children: [
                    if (isReceptionist())
                      CommonRowWidget(
                          ...
                          value: upcomingAppointment.doctor_name.validate(),
                          isMarquee: true),
                    CommonRowWidget(
                        title: locale.lblService,
                        value:
                            '${upcomingAppointment.visit_type!.map((e) => e.service_name.validate()).join(" , ")}'),
                    CommonRowWidget(
                        title: locale.lblDate,
                        value: upcomingAppointment.appointment_start_date
                            .validate()
                            .getFormattedDate(APPOINTMENT_DATE_FORMAT)),
                    CommonRowWidget(
                        title: locale.lblTime,
                        value:
                            '${DateFormat(TIME_WITH_SECONDS).parse(upcomingAppointment.appointment_start_time!).getFormattedDate(FORMAT_24_HOUR)} - ${DateFormat(TIME_WITH_SECONDS).parse(upcomingAppointment.appointment_end_time!).getFormattedDate(FORMAT_24_HOUR)}'),
                    CommonRowWidget(
                ...
                if (upcomingAppointment.appointment_report
                    .validate()
                    .isNotEmpty)
                  Divider(height: 16),
                if (upcomingAppointment.appointment_report
                    ...
                    children: List.generate(
                      ...
                      (index) {
                        AppointmentReport data =
                            upcomingAppointment.appointment_report![index];
