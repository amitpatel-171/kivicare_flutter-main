...
abstract class AppStoreBase with Store {
  ...
  @action
  Future<void> setGoogleUsername(String value,
      {bool initiliaze = false}) async {
  ...
  @action
  Future<void> setGooglePhotoURL(String value,
      {bool initiliaze = false}) async {
  ...
  Future<void> setUserEnableGoogleCal(String value,
      {bool initiliaze = false}) async {
  ...
  Future<void> setUserDoctorGoogleCal(String value,
      {bool initiliaze = false}) async {
