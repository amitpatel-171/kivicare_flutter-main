...
Future<List<DoctorList>> getDoctorListNew1({
  int? clinicId,
  required int page,
  required List<DoctorList> doctorList,
  Function(bool)? lastPageCallback,
  Function(int)? getTotalDoctor,
}) async {
...
Future<List<DoctorList>> getDoctorListNew(
    {required int page,
    required List<DoctorList> doctorList,
    Function(bool)? lastPageCallback,
  ...
  DoctorListModel res = DoctorListModel.fromJson(await (handleResponse(
      await buildHttpResponse(getEndPoint(
          endPoint: 'kivicare/api/v1/doctor/get-list', page: page)))));
  appStore.setLoading(true);
