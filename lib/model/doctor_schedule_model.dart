  ...
  factory DoctorSessionModel.fromJson(Map<String, dynamic> json) {
    return DoctorSessionModel(
      sessionData: json['data'] != null
          ? (json['data'] as List).map((i) => SessionData.fromJson(i)).toList()
          : null,
      total: json['total'],
    );
  }
...
class SessionData {
  ...
  String get morningStart =>
      '${s_one_start_time!.hH.validate(value: '00')}:${s_one_start_time!.mm.validate(value: '00')}';
  String get morningEnd =>
      '${s_one_end_time!.hH.validate(value: '00')}:${s_one_end_time!.mm.validate(value: '00')}';
  String get eveningStart =>
      '${s_two_start_time!.hH.validate(value: '00')}:${s_two_start_time!.mm.validate(value: '00')}';
  String get eveningEnd =>
      '${s_two_end_time!.hH.validate(value: '00')}:${s_two_end_time!.mm.validate(value: '00')}';
  ...
  factory SessionData.fromJson(Map<String, dynamic> json) {
    return SessionData(
      ...
      id: json['id'],
      s_one_end_time: json['s_one_end_time'] != null
          ? SOneEndTime.fromJson(json['s_one_end_time'])
          : null,
      s_one_start_time: json['s_one_start_time'] != null
          ? SOneEndTime.fromJson(json['s_one_start_time'])
          : null,
      s_two_end_time: json['s_two_end_time'] != null
          ? SOneEndTime.fromJson(json['s_two_end_time'])
          : null,
      s_two_start_time: json['s_two_start_time'] != null
          ? SOneEndTime.fromJson(json['s_two_start_time'])
          : null,
