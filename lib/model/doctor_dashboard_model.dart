...
class DoctorDashboardModel {
  ...
  factory DoctorDashboardModel.fromJson(Map<String, dynamic> json) {
    return DoctorDashboardModel(
      ...
      weekly_appointment: json['weekly_appointment'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.weekly_appointment != null) {
      data['weekly_appointment'] =
          this.weekly_appointment!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class UpcomingAppointment {
  ...
  String get getAppointmentTime =>
      DateFormat(TIME_WITH_SECONDS)
          .parse(appointment_start_time.validate())
          .getFormattedDate(FORMAT_24_HOUR) +
      " - " +
      DateFormat(TIME_WITH_SECONDS)
          .parse(appointment_end_time.validate())
          .getFormattedDate(FORMAT_24_HOUR);

  String get getAppointmentStartTime => appointment_start_date
      .validate()
      .getFormattedDate(APPOINTMENT_DATE_FORMAT);

  String get getVisitTypes =>
      visit_type.validate().map((e) => e.service_name.validate()).join(", ");
  ...
  factory UpcomingAppointment.fromJson(Map<String, dynamic> json) {
    return UpcomingAppointment(
      ...
      description: json['description'].toString().validate().isNotEmpty
          ? json['description']
          : "NA",
      appointment_report: json['appointment_report'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.appointment_report != null) {
      data['appointment_report'] =
          this.appointment_report!.map((v) => v.toJson()).toList();
    }
